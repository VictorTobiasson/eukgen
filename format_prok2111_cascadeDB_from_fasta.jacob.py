...
from paths_and_parameters import prok2111, mmseqs_cascade_opts, path_processing
...
cascade_clusterDB = '/data/luojaa/eukgen/processing/prok2111/prok2111.repseq.cascaded_cluster'
# extract fastas from cluters and realign
# fasta_root = extract_query_fasta(root, seqDB, cascade_clusterDB) # might run into mergeseqdb problem, which should be resolved within the function
fasta_root = '/data/luojaa/eukgen/processing/prok2111/cluster_fastas/'
...
# change run settings from 72 cores
# search new databse against itself
output_DB_root = root
HHsuiteDB_name = 'prok2111'
mpis = 24
