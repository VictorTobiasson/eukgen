...
#     microcosm_format_opts["taxonomy_mapping"] = '/data/luojaa/eukgen/mmseqs_victor/euk_prok_merged_protein_revised.tax'
#     microcosm_format_opts['original_query_DB'] = '/data/luojaa/eukgen/mmseqs_victor/euk72_ep/euk72_ep.repseq'
#     microcosm_format_opts['original_target_DB'] = '/data/luojaa/eukgen/mmseqs_victor/prok2111_as/prok2111_as.repseq'
