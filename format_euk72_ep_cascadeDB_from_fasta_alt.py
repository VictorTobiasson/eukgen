...
root = path_processing + '/euk72_ep2/'
seqDB = euk72_ep
threads = 48
...
#
# # nonredundant_repeq = '/data/tobiassonva/data/eukgen/processing/euk72_ep/euk72_ep.repseq'
#
...
cascade_clusterDB = '/vf/users/tobiassonva/data/eukgen/processing/euk72_ep2/euk72_ep.repseq.cascaded_cluster'
...
output_DB_root = root
HHsuiteDB_name = 'euk72_ep'
mpis = 24
search_root = root + 'self_search2/'
splits = 500
