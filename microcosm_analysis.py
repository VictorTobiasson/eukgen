...
def microcosm_run(file_root, file_basename, threads, save_intermediate_files):
    ...
    query_fasta = file_root + file_basename + '.query.fasta'
    target_fasta = file_root + file_basename + '.target.fasta'
    merged_fasta = file_root + file_basename + '.merged.fasta'
    treefile = file_root + file_basename + '.merged.fasta.muscle.treefile'
